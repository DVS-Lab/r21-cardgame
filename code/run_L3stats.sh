...
for analysistype in type-ppi_seed-rightVS type-ppi_seed-leftVS; do
#for analysistype in type-act type-ppi_seed-rightVS type-ppi_seed-leftVS type-nppi-lfpn type-nppi-rfpn type-nppi-ecn type-nppi-dmn; do
